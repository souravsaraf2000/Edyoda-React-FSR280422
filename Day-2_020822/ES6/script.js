...
// const filteredProducts = products.filter(product => product.price >= 700)
...
// let sumArr = arr.reduce((a,item)=>{
//     return a+item
// },0)

// console.log(sumArr)

// let res = products.find(item => item.id === 5)
// console.log(res)

// let res = products.findIndex(item => item.id === 555)
// console.log(res)

// setTimeout(()=>{
//     console.log('Hello From Set timeout 1')
//     setTimeout(()=>{
//         console.log('Hello From Set timeout 2')
//         setTimeout(()=>{
//             console.log('Hello From Set timeout 3')
//         }, 2000)
//     },3000)
// }, 5000)
...
//     console.log(data)
//     $.get('https://dummyjson.com/users', (data)=>{
//         console.log(data)
//         $.get('https://dummyjson.com/posts',(data)=>{
//             console.log(data)
//         })
//     })
// })
